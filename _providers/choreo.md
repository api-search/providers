...
- description: The Choreo API Management API provides programmatic access to manage the full lifecycle of APIs on the WSO2 Choreo platform. It allows API creators to create, publish, version, and manage APIs, manage
  ...
  slug: api-management
- description: The Choreo Developer Portal API enables API consumers to discover, evaluate, subscribe to, and consume APIs hosted on the Choreo platform. It provides access to the API marketplace, application manage
  name: Choreo Developer Portal API
  slug: developer-portal
- description: The Choreo Insights API provides access to observability, monitoring, and analytics data for APIs and components deployed on the Choreo platform. It enables users to programmatically retrieve usage st
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/choreo/refs/heads/main/apis.yml
tags:
- AI Apps
- API Management
- CI/CD
