...
- description: 'The MCP Cloud platform by Speakeasy. Ship better agents with production-ready MCP infrastructure. Host remote MCP servers, power in-application chat, and manage and secure MCP servers for your entire '
  ...
  slug: gram
capabilities:
- description: Unified workflow capability for managing the Speakeasy SDK generation platform. Combines workspace management, organization administration, artifact registry, code sample retrieval, and OpenAPI improv
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/speakeasy/refs/heads/main/apis.yml
tags:
- AI
- Documentation
- MCP
