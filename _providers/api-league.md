...
slug: api-league
solutions: []
source_yaml: "aid: api-league\nname: API League\ndescription: >-\n  API League is a comprehensive API marketplace aggregating 60+ best-in-class\n  APIs across categories including books, news, humor, food, knowledge, art,\n  web, text processing, and media. It offers code examples in 21 languages,\n  SDKs, Postman collections, and free API key access for developers to launch\n  projects quickly.\ntype: Index\nimage: https://kinlane-productions.s3.amazonaws.com/apis-json/apis-json-logo.jpg\ntags:\n  - API Marketplace\n  - Books\n  - Developer Tools\n  - Food\n  - Humor\n  - News\n  - SDKs\n  - Text Processing\nurl: >-\n  https://raw.githubusercontent.com/api-evangelist/api-league/refs/heads/main/apis.yml\ncreated: '2025-03-01'\nmodified: '2026-04-19'\nspecificationVersion: '0.19'\napis:\n  - aid: api-league:api-league-platform\n    name: API League Platform\n    description: >-\n      The API League Platform provides access to 60+ APIs spanning books, news,\n      humor, food, knowledge,\
  \ art, web, text processing, and media categories.\n      Authentication uses API keys with free signup. SDKs are available in 21\n      programming languages including Java, JavaScript, Python, Go, and C#.\n    humanURL: https://apileague.com\n    tags:\n      - API Marketplace\n      - Developer Tools\n      - Multi-Category\n      - SDK\n    properties:\n      - type: Documentation\n        url: https://apileague.com/apis/\n      - type: SignUp\n        url: https://apileague.com\ncommon:\n  - type: Website\n    url: https://apileague.com\n  - type: Documentation\n    url: https://apileague.com/apis/\n  - type: Discord\n    url: https://discord.gg/apileague\n  - type: Features\n    data:\n      - name: 60+ APIs\n        description: Access to over 60 best-in-class APIs across books, news, humor, food, knowledge, art, web, text, and media categories.\n      - name: SDKs in 21 Languages\n        description: Official SDKs available in 21 programming languages including Java, JavaScript,\
  \ Python, Go, and C#.\n      - name: Postman Collections\n        description: Ready-to-use Postman collections for testing and exploring all available APIs.\n      - name: Code Examples\n        description: Multi-language code examples for every API endpoint.\n      - name: Free API Key\n        description: Free API key signup allowing immediate access to the platform without upfront payment.\n      - name: AI Chat Assistant\n        description: Built-in AI chat assistant to help developers navigate the API catalog.\n  - type: UseCases\n    data:\n      - name: Content Applications\n        description: Build news aggregators, book discovery apps, and article readers using News and Books APIs.\n      - name: Food and Recipe Platforms\n        description: Integrate recipe search, nutrition data, and drink recommendations into food applications.\n      - name: Text Analysis\n        description: Add sentiment analysis, language detection, readability scoring, and entity extraction to\
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/api-league/refs/heads/main/apis.yml
tags:
- API Marketplace
- Books
- Developer Tools
...
- SDKs
- Text Processing
url: https://raw.githubusercontent.com/api-evangelist/api-league/refs/heads/main/apis.yml
use_cases:
- description: Build news aggregators, book discovery apps, and article readers using News and Books APIs.
  name: Content Applications
- description: Integrate recipe search, nutrition data, and drink recommendations into food applications.
