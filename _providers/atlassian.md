...
- description: Platform administration workflow combining Admin Organizations, User Management, User Provisioning, and Jira Configuration APIs for IT administrators to manage users, groups, organizations, and platfo
...
features:
- description: Agile project management and issue tracking platform for software development teams with Scrum and Kanban boards.
  name: Jira Software
- description: Team workspace for creating, sharing, and collaborating on documentation, knowledge bases, and project plans.
  name: Confluence
- description: Git-based source code repository hosting with built-in CI/CD pipelines, code review, and branch management.
  name: Bitbucket
- description: IT service management platform with ITSM workflows, incident management, asset tracking, and customer portals.
  name: Jira Service Management
- description: Visual project management tool using boards, lists, and cards for organizing work and tracking progress.
  name: Trello
- description: Status page hosting service for communicating system status, incidents, and scheduled maintenance to stakeholders.
  name: Statuspage
- description: Developer experience platform for tracking software component health, dependencies, and team ownership.
  name: Compass
- description: Serverless cloud app development platform for building Atlassian integrations hosted on Atlassian infrastructure.
  name: Forge Platform
- description: Framework for building cloud apps that extend Jira, Confluence, and other Atlassian products with custom functionality.
  name: Atlassian Connect
- description: Organization-level administration for managing users, groups, domains, policies, and product access across Atlassian Cloud.
  name: Atlassian Admin
- description: Remote MCP server that connects Jira and Confluence with LLMs, IDEs, and AI agent platforms.
