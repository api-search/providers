...
image: /assets/icons/about-exim-exim-gov-export-import-bank-of-the-united-states.png
integrations:
...
skills: []
slug: about-exim-exim-gov-export-import-bank-of-the-united-states
solutions: []
source_yaml: "aid: about-exim-exim-gov-export-import-bank-of-the-united-states\nurl: https://raw.githubusercontent.com/api-evangelist/about-exim-exim-gov-export-import-bank-of-the-united-states/refs/heads/main/apis.yml\nname: Export-Import Bank of the United States\ntype: Index\nimage: https://kinlane-productions.s3.amazonaws.com/apis-json/apis-json-logo.jpg\ntags:\n  - Export\n  - Federal Government\n  - Finance\n  - Import\n  - Trade Finance\ndescription: >-\n  The U.S. Export-Import Bank (EXIM) is the official export credit agency of\n  the United States federal government. It assists in financing and facilitating\n  U.S. exports of goods and services by providing export credit insurance,\n  working capital guarantees, and direct loans to help American businesses\n  compete in the global marketplace. EXIM publishes open government data\n  including authorization records accessible via the federal Data.gov catalog\n  using the Socrata Open Data API (SODA).\ncreated: '2024-07-11'\nmodified:\
  \ '2026-04-19'\nspecificationVersion: '0.19'\napis:\n  - aid: about-exim-exim-gov-export-import-bank-of-the-united-states:open-data\n    name: EXIM Open Data API\n    tags:\n      - Export\n      - Federal Government\n      - Finance\n      - Open Data\n    humanURL: https://www.exim.gov/open-government-data\n    properties:\n      - type: Documentation\n        url: https://www.exim.gov/open-government-data\n      - type: APIReference\n        url: https://dev.socrata.com/foundry/data.exim.gov/8mmf-is58\n    description: >-\n      EXIM Bank publishes open government datasets through the federal Data.gov\n      catalog. Datasets include export authorization records from 2006 onward,\n      accessible programmatically via the Socrata Open Data API (SODA). The Chief\n      Data Officer can be contacted at CDO@exim.gov for dataset requests.\ncommon:\n  - type: Website\n    url: https://www.exim.gov/\n  - type: Portal\n    url: https://eximonline.exim.gov/\n  - type: GettingStarted\n    url:\
  \ https://www.exim.gov/open-government-data\n  - type: Blog\n    url: https://grow.exim.gov/blog\n  - type: Contact\n    url: https://www.exim.gov/contact/contact-form\n  - type: PrivacyPolicy\n    url: https://www.exim.gov/privacy-and-security-policy\n  - type: LinkedIn\n    url: https://www.linkedin.com/company/export-import-bank-of-the-united-states/\n  - type: YouTube\n    url: https://www.youtube.com/user/EximBank\n  - type: Features\n    data:\n      - name: Export Credit Insurance\n        description: Insurance products protecting US exporters against non-payment by foreign buyers due to commercial or political risks.\n      - name: Working Capital Guarantees\n        description: Loan guarantees enabling US businesses to obtain working capital financing from commercial lenders for export activities.\n      - name: Loan Guarantees\n        description: Guarantees on loans made by private lenders to foreign buyers for purchases of US goods and services.\n      - name: Direct Loans\n\
