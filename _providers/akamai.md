...
- description: The API Endpoint Definition API allows you to programmatically define an API endpoint and its set of component resources. If youre a Kona Site Defender customer, you can define request body and resour
...
- description: The Application Security API allows you to access and modify your Security Configurations for Kona Site Defender, Web Application Protector, App.
...
- description: The Certificate Provisioning System (CPS) provides full life cycle management of SSL/TLS certificates for your Akamai Secure Delivery Network applications. This includes ability to request new certifi
...
- description: The CP Codes and Reporting Groups API offers a programmatic interface to manage CP codes and reporting groups. It also details contracts and products associated with each CP code, and contracts and CP
...
- description: You can use the administrative APIs to control EdgeKV database functions outside EdgeWorkers JavaScript code. The APIs enable you to perform day-to-day operations, including creating new namespaces, u
  name: Akamai EdgeKV API
  slug: akamai-edgekv-api
- description: 'You can use the EdgeWorkers service to run JavaScript at the edge of the Internet to dynamically manage web traffic. You can use the EdgeWorkers API to deploy custom code on thousands of edge servers '
...
- description: The Fast Purge API provides a programmatic interface for you to purge edge content. In this version, purge your own set of URLs or ARLs (Akamai resource locators), or any content grouped under a conte
...
- description: The Network Lists API allows you to manage a common set of lists for use in various Akamai security products such as Kona Site Defender, Web App Protector, and Bot Manager. Network lists are shared se
...
- description: The Property Manager API (PAPI) offers a programmatic interface to manage how Akamai edge servers process requests, responses, and objects served over the Akamai platform. A distributed property confi
...
- description: Resolving issues with your website and applications after a property is pushed to the content delivery network is inefficient and a drain on resources. With Sandbox, you can tweak your site delivery o
...
- description: The Security Information and Event Management API allows you to capture security events generated on the Akamai platform in your SIEM application.
...
- description: The Site Shield API offers a programmatic interface that provides an additional layer of defense for your critical websites and web applications. This API removes websites and applications from intern
...
capabilities:
- description: Unified workflow for managing Akamai edge platform resources including EdgeWorkers serverless functions, network lists, and property configurations. For platform engineers and DevOps teams managing Ak
...
features:
- description: Global CDN with 4,000+ locations in 130+ countries for fast, reliable content delivery.
  name: Content Delivery Network
- description: Serverless JavaScript execution at the edge enabling custom logic for traffic management and content manipulation.
  name: EdgeWorkers
- description: Distributed key-value store at the edge for low-latency data access in EdgeWorkers applications.
  name: EdgeKV
- description: Configuration management for edge delivery rules, caching, security, and performance optimizations.
  name: Property Manager
- description: Prolexic DDoS mitigation service protecting networks and applications from volumetric attacks.
  name: DDoS Protection
- description: Application security protecting against OWASP Top 10, bots, and API attacks via App and API Protector.
  name: Web Application Firewall
- description: Customer identity and access management (CIAM) platform for registration, authentication, and social login.
  name: Identity Cloud
- description: Linode cloud platform providing virtual machines, Kubernetes, databases, and storage services worldwide.
...
source_yaml: "aid: akamai\nurl: >-\n  https://raw.githubusercontent.com/api-evangelist/akamai/refs/heads/main/apis.yml\napis:\n- aid: akamai:akamai-access-revocation-api\n  name: Akamai Access Revocation API\n  tags: []\n  humanURL: https://techdocs.akamai.com/adaptive-media-delivery/reference/api\n  properties:\n  - url: https://techdocs.akamai.com/adaptive-media-delivery/reference/api\n    type: Documentation\n  description: >-\n    Adaptive Media Delivery supports Token Authentication. You can apply it to generate\n    unique tokens and include them in requests for your content. Akamai validates\n    these tokens to grant access to your media. Access Revocation lets you recognize\n    tokens that have been hijacked and flag them to block requests that include\n    them. Use the Access Revocation API to generate a revocation list of these tokens.\n- aid: akamai:akamai-adaptive-acceleration-api\n  name: Akamai Adaptive Acceleration API\n  tags: []\n  humanURL: https://techdocs.akamai.com/adaptive-acceleration/reference/api\n\
...
- Platform
- Security
url: https://raw.githubusercontent.com/api-evangelist/akamai/refs/heads/main/apis.yml
use_cases:
