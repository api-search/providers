...
- description: SOAP API for Professional Services Automation integrations. Exposes Workday Financials data for managing client-facing projects, services billing, resource staffing, and expense reporting within profe
  ...
  slug: ''
capabilities:
- description: Unified capability for financial operations combining general ledger management, procurement, and accounts payable workflows. Enables finance teams to manage the full procure-to-pay and record-to-repo
